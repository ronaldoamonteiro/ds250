...
df = df.rename(columns={
  'Have you seen any of the 6 films in the Star Wars franchise?': 'Question_1',
  'Do you consider yourself to be a fan of the Star Wars film franchise?': 'Question_2',
  'Which of the following Star Wars films have you seen? Please select all that apply.': 'Question_3'})
df
```
